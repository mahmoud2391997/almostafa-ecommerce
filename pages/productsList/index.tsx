...
export default function DairyDerivatives() {
  ...
  useEffect(() => {
    if (
      query &&
      query.category &&
      categories.some((cat) => cat._id === query.category)
    ) {
  ...
  return (
    <div className=" px-[1%] responsive-height   xl:px-[2.5%]">
      ...
      <div className="h-1 bg-white w-[65px] mr-3"></div>  {translations.productsList}<div className="h-1 bg-white w-[65px] ml-3"></div>
        </h1>
      </div>
