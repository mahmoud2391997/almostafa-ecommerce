    ...
    {categoriesLoading || productsLoaing ? (
      ...
      <section className="w-full">
         <div className="w-auto flex flex-col items-center justify-center my-3 mb-2">
           <h1 className="text-center text-[var(--foreground)] text-xl sm:text-2xl md:text-3xl flex items-center lg:text-4xl xl:text-6xl font-extrabold mb-2">
           <div className="h-1 bg-[var(--foreground)] w-[65px] mr-3"></div>  {translations.categories}<div className="h-1 bg-[var(--foreground)] w-[65px] ml-3"></div>
           </h1>
         </div>
