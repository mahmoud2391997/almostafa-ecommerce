      ...
      >
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="md:hidden flex items-center gap-4">
            {/* Cart icon for mobile - visible all the time */}
            <Link href="/cart" className="text-white hover:text-gray-200 flex items-center relative">
        ...
        {/* Desktop cart and language dropdown */}
